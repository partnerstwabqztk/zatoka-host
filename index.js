...
const client = new Client({
  ...
  intents: [
    ...
    Intents.FLAGS.GUILD_MESSAGES,      // opcjonalnie, jeśli w przyszłości będziesz nasłuchiwał wiadomości na serwerach
    Intents.FLAGS.DIRECT_MESSAGES,
    Intents.FLAGS.MESSAGE_CONTENT,     // konieczne, by odczytywać treści wiadomości
  ],
  partials: ['CHANNEL', 'MESSAGE'],    // potrzebne, by prawidłowo obsługiwać DM’y
});
...
// Bezpieczne logowanie z ENV
if (!process.env.TOKEN) {
  console.error('❌ Brak zmiennej TOKEN w ENV!');
  process.exit(1);
}
